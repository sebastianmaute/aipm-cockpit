...
| `npm run desktop:typecheck` | Typecheck the Electron shell (desktop/tsconfig.json), which the root tsc excludes. Needs desktop/node_modules: locally it SKIPS visibly without them, under CI it exits 2. Exit 1 = type errors. |
