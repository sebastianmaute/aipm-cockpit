...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Add MFA to SSO scope | <p>Extend the current SSO implementation to require multi-factor authentication (TOTP / push) for all privileged accounts before production go-live. Driven by updated InfoSec policy issued 2026-05-20.</p> | Scope | Under Review | High | <p>Adds ~3 weeks of backend + frontend work. Requires additional security review cycle and re-scoping of load-test scenarios.</p> | 21 | 18000 | Morgan Standin | 2026-05-21 | Elena Fischer |  |  | 2 | 4 | 1\|5 | 2026-05-21T09:00:00.000Z |  |  |
