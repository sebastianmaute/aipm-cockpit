...
| ID | Category | Title | Description | Severity | Probability | Impact | Status | Owner | OwnerEmail | OwnerResourceId | Mitigation | LinkedTasks | Raised | Target | Closed | LocalModified | CausedByIds | StakeholderIds | DocumentLinks | OutlookEventId |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
