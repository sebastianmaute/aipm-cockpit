...
export const de: Record<TranslationKey, string> = {
  ...
  budgetCciInternalCostIndex: "Interner Kostenindex",
  ...
  forecastFactAc: "Ist (AC)",
  forecastFactRemaining: "Restbudget",
  forecastFactEv: "Erarbeiteter Wert (EV)",
  forecastPaceTitle: "Beim aktuellen Tempo",
  forecastPaceQuestion: "die Ausgaben so weitergehen wie in den letzten {0} Arbeitstagen",
  forecastEfficiencyTitle: "Bei aktueller Effizienz",
  forecastEfficiencyQuestion: "die restliche Arbeit so viel kostet wie die bereits fertiggestellte Arbeit",
  forecastEacPace: "EAC beim aktuellen Tempo",
  forecastEacEfficiency: "EAC bei aktueller Effizienz",
  forecastVacPace: "VAC beim aktuellen Tempo",
  forecastVacEfficiency: "VAC bei aktueller Effizienz",
  forecastEtcPace: "ETC beim aktuellen Tempo",
  forecastEtcEfficiency: "ETC bei aktueller Effizienz",
  forecastBurnRate: "Verbrauchsrate",
  forecastPerDay: "{0}/Tag",
  forecastRunOut: "Aufgebraucht",
  forecastRunOutBefore: "{0}, {1} Tage vor Planende",
  forecastRunOutAfter: "{0}, {1} Tage nach Planende",
  forecastRunOutOnEnd: "{0}, am Planende",
  forecastRunOutAlready: "Bereits aufgebraucht",
  forecastCpi: "CPI",
  forecastSpi: "SPI",
  forecastNeeds: "Benötigt",
  forecastPaceNotEnough: "Nicht genug aktuelle Buchungen",
  forecastPaceNoBurn: "Keine aktuellen Buchungen",
  forecastEfficiencyNeedsPercent: "Benötigt verknüpfte Aufgaben oder einen Fertigstellungsgrad",
  forecastEfficiencyNoCost: "Noch nichts ausgegeben",
  forecastEfficiencyNoEarned: "Noch nichts erarbeitet",
  forecastFixedPriceNote: "Festpreis: Die Überschreitung ist interner Aufwand; der Kundenpreis ändert sich nicht.",
  forecastWindowLine: "Verbrauchsrate aus {0} – {1} ({2} Arbeitstage)",
  forecastGapInfo: "Die Tempo- und Effizienzprognosen unterscheiden sich um {0} ({1} des Budgets).",
  forecastGapWarning: "Warnung: Die Tempo- und Effizienzprognosen unterscheiden sich um {0} ({1} des Budgets).",
  forecastExtraDaysTerm: "Zusätzliche Arbeitstage",
  forecastGapExtraDays: "Bei aktueller Effizienz braucht die Arbeit {0} Arbeitstage über das geplante Ende hinaus; die Tempo-Prognose nimmt an, dass sie pünktlich fertig wird.",
  forecastBannerStartsOn: "Die Tempo-Prognose beginnt am {0}. Sie braucht {1} Arbeitstage mit Buchungen; bisher sind es {2}, beginnend am {3}.",
  forecastBannerStartsOnceBooked: "Die Tempo-Prognose beginnt, sobald Stunden gebucht sind. Sie braucht {0} Arbeitstage mit Buchungen.",
  forecastBannerNoBurn: "In den letzten {0} Arbeitstagen ({1} – {2}) wurden keine Stunden gebucht, daher gibt es keine Tempo-Prognose.",
  forecastBannerLastBooking: "Letzte Buchung: {0}.",
  forecastBannerSpreadMonth: "Ein Teil der Verbrauchsrate stammt aus monatlich erfassten Stunden. Sie wurden gleichmäßig auf die Arbeitstage des Monats verteilt.",
  forecastBannerSpreadWeek: "Ein Teil der Verbrauchsrate stammt aus wöchentlich erfassten Stunden. Sie wurden gleichmäßig auf die Arbeitstage der Woche verteilt.",
  forecastBannerNeedsPercent: "Die Effizienz-Prognose braucht einen Fertigstellungsgrad für jeden Budgetposten. Es fehlt: {0}.",
  forecastShortStartsOn: "Tempo-Prognose ab {0}",
  forecastShortOnceBooked: "Tempo-Prognose beginnt, sobald Stunden gebucht sind",
  forecastShortNoBurn: "Keine aktuellen Buchungen",
  forecastShortSpread: "Verbrauchsrate teils aus periodenweise erfassten Stunden",
  forecastShortNeedsPercent: "Effizienz-Prognose braucht einen Fertigstellungsgrad",
  forecastInHours: "In Stunden",
  forecastEacHours: "EAC in Stunden",
  forecastVacHours: "VAC in Stunden",
  forecastRunOutHours: "Aufgebraucht (Stunden)",
  forecastCpiHours: "CPI (Stunden)",
  forecastTipCpiHours:
    "CPI in Stunden: verdiente Budgetstunden {0} ÷ gebuchte Stunden {1} = {2}. Verglichen werden Budgetstunden, nicht Aufgabenaufwand.",
  forecastMixChipHoursWorse: "Aufwand schlechter als €",
  forecastMixChipEurWorse: "€ schlechter als Aufwand",
  forecastMixChipNamePace: "{0} beim aktuellen Tempo – warum?",
  forecastMixChipNameEfficiency: "{0} bei aktueller Effizienz – warum?",
  forecastMixWhy: "{0} – warum?",
  forecastMixLeadWarning: "Warnung:",
  forecastMixLeadNote: "Hinweis:",
  forecastMixHeadHoursWorse: "Die Stunden zeichnen ein schlechteres Bild als das Budget.",
  forecastMixHeadEurWorse: "Das Budget zeichnet ein schlechteres Bild als die Stunden.",
  forecastMixDriver: "{0}: {1} der gebuchten Stunden (geplant {2}),",
  forecastMixRateAfterDriver: "daher liegt der Stundensatz im Schnitt bei {0}/h statt {1}/h.",
  forecastMixRate: "Der Stundensatz liegt im Schnitt bei {0}/h statt {1}/h.",
  forecastMixPaceHoursWorse: "Beim aktuellen Tempo zeigen die Stunden {0}, das Budget {1}.",
  forecastMixPaceEurWorse:
    "Beim aktuellen Tempo zeigt das Budget {0}, die Stunden nur {1}. Der Unterschied liegt im Satz, nicht in den Stunden.",
  forecastMixTileHoursWorse: "Stunden {0} · aufgebraucht am {1}",
  forecastMixTileHoursWorseNoRunOut: "Stunden {0}",
  forecastMixTileEurWorse: "Stunden nur {0} – die Überschreitung liegt im Satz",
  forecastMixAction: "Wohin die Stunden gingen",
  forecastMixSummary: "Anteil der gebuchten Stunden je Rolle im Vergleich zum Plan",
  forecastMixColRole: "Rolle oder Disziplin",
  forecastMixColRate: "Geplanter Satz",
  forecastMixColPlanned: "Geplanter Anteil",
  forecastMixColBooked: "Gebuchter Anteil",
  forecastMixColDifference: "Differenz",
  forecastMixColUsed: "Verbrauchte Stunden vom Budget",
  forecastMixPoints: "{0} Pkt.",
  forecastMixUsed: "{0} von {1} ({2})",
  forecastMixDriverBadge: "Treiber",
  forecastMixOnPlan: "Keine Rolle weicht um {0} Punkte oder mehr von ihrem geplanten Anteil ab.",
  forecastMixFixedPriceScope: "Die Satzwerte umfassen nur Stundenposten; {0} aus Festpreis-Posten sind ausgenommen.",
  forecastFactRate: "Ø gebuchter Satz",
  forecastRatePerHour: "{0}/h",
  forecastRateDrift: "{0} ggü. Plan",
  forecastRateOnPlan: "im Plan",
  forecastTipRate:
    "Vertragswert der bisher gebuchten Stunden ÷ diese Stunden: {0} ÷ {1} = {2}/h. Geplanter Durchschnitt: {3} ÷ {4} = {5}/h. Weichen beide ab, erzählen die €- und die Stundenprognose Unterschiedliches.",
  burndownViewLabel: "Diagrammausrichtung",
  burndownViewBurndown: "Burn-down",
  burndownViewCumulative: "Kumuliert",
  burndownUnitLabel: "Diagrammeinheit",
  burndownUnitEur: "€",
  burndownUnitHours: "Stunden",
  burndownValueCumulative: "Ausgaben, kumuliert",
  burndownHoursCumulative: "Stunden, kumuliert",
  burndownEv: "Earned Value (heute)",
  burndownEvHistory: "Earned Value",
  burndownOver: "über",
  burndownWorkLeft: "offene Arbeit {0}",
  burndownBac: "BAC {0}",
  burndownFrameNote:
  ...
  burndownAriaEndPace: "Abweichung zum Planende: {0} beim aktuellen Tempo.",
  burndownAriaEndEfficiency: "Abweichung zum Planende: {0} bei aktueller Effizienz.",
  burndownBacBaseline: "Budget bei Aufzeichnungsbeginn",
  ...
  burndownBacMarkerRemoved: "{0} {1} entfernt",
  burndownAriaBudgetChanges: "Budgetänderungen: {0}.",
  budgetChangeTableCaption: "Budgetänderungen ({0})",
  budgetChangeColDate: "Datum",
  budgetChangeColBucket: "Bucket",
  budgetChangeColChange: "Änderung",
  budgetChangeColCumulative: "Zusätzlicher Umfang bisher",
  budgetChangeRemoved: "entfernt",
  budgetChangePaceNote: "Aufteilung gegen die Tempo-Prognose.",
  forecastLinkRange: "Prognose: EAC {0}–{1}",
  forecastLinkSingle: "Prognose: EAC {0}",
  forecastLinkStartsOn: "Prognose ab {0}",
  forecastLinkOnceBooked: "Prognose beginnt, sobald Stunden gebucht sind",
  forecastLinkNoBurn: "Keine aktuellen Buchungen",
  forecastTipBac: "Budget bei Fertigstellung: der gesamte Vertragswert aller Budgetposten, {0}. Alles Weitere wird daran gemessen.",
  forecastTipAc: "Ist-Kosten: der Wert aller bisher gebuchten Stunden, {0}. Festpreis-Posten zählen ihren Anteil am Vertrag ohne Deckelung, damit eine Überschreitung sichtbar wird.",
  forecastTipRemaining: "Restbudget: Budget {0} − Ist-Kosten {1} = {2}.",
  forecastTipEv: "Erarbeiteter Wert: der Budgetwert der tatsächlich fertiggestellten Arbeit: {1} des Budgets fertig = {0}. Er kann niedriger sein als das Ausgegebene (AC), wenn die Arbeit mehr kostet als geplant.",
  forecastTipPace: "Nimmt an, dass die Ausgaben im Durchschnitt der letzten {0} Arbeitstage bis zum geplanten Enddatum weitergehen. Berücksichtigt nur den Kalender: Es wird angenommen, dass die Arbeit zum Planende fertig ist, unabhängig vom tatsächlichen Fortschritt. Dies ist eine kalenderbasierte Burndown-Methode.",
  forecastTipEfficiency: "Nimmt an, dass die restliche Arbeit je Einheit so viel kostet wie die bereits fertiggestellte. Berücksichtigt nur den Umfang: was die Fertigstellung der restlichen Arbeit kostet, unabhängig vom Kalender. Dies ist die Standardmethode der Earned-Value-Analyse (EVM).",
  forecastTipEac: "Schätzung bei Fertigstellung: was das Projekt insgesamt gekostet haben wird: Ist-Kosten {0} + ETC {1} = {2}. Über dem Budget heißt: Überschreitung.",
  forecastTipVac: "Abweichung bei Fertigstellung: Budget − Schätzung bei Fertigstellung. Negativ heißt: Das Budget wird um diesen Betrag überschritten: {0} − {1} = {2}.",
  forecastTipEtcPace: "Restkostenschätzung: was noch ausgegeben werden muss. Beim aktuellen Tempo = Verbrauchsrate {0} × {1} verbleibende Arbeitstage = {2}.",
  forecastTipEtcEfficiency: "Restkostenschätzung: was die Fertigstellung der restlichen Arbeit kostet. (Budget {0} − erarbeiteter Wert {1}) ÷ CPI {2} = {3}.",
  forecastTipCpi: "Kostenleistungsindex: erarbeiteter Wert {0} ÷ Ist-Kosten {1} = {2}. 1,00 bedeutet: Die Arbeit kostet so viel wie budgetiert; unter 1 bedeutet: Sie kostet mehr als geplant.",
  forecastTipSpi: "Terminleistungsindex: erarbeiteter Wert {0} ÷ Planwert {1} = {2}. 1,00 bedeutet: im Zeitplan; unter 1 bedeutet: hinter dem Zeitplan.",
  forecastTipBurnRate: "Durchschnittliche Ausgabe je Arbeitstag: {0} gebucht ÷ {1} Arbeitstage = {2} pro Tag.",
  forecastTipRunOut: "Der Tag, an dem das Restbudget {0} aufgebraucht ist, wenn die Ausgaben mit der Verbrauchsrate von {1} pro Tag weitergehen. Vor dem Planende heißt: Das Budget reicht nicht bis zum Ende.",
  forecastTipNeeds: "Fertigstellungsgrad, aus den mit dem Budgetposten verknüpften Aufgaben oder einem manuell eingetragenen Fertigstellungsgrad auf dem Posten. Ohne ihn kann diese Karte nicht berechnet werden und zeigt, was fehlt.",
  forecastTipExtraDays: "Bei aktueller Effizienz braucht die restliche Arbeit ETC {0} ÷ Verbrauchsrate {1} = {2} Arbeitstage, {3} mehr als bis zum Planende bleiben.",
  forecastSplitSince: "Seit {0}",
  forecastSplitPerformance: "Leistung",
  forecastSplitScope: "Zusätzlicher Umfang",
  forecastSplitUnattributed: "Nicht zugeordnete Budgetänderung",
  forecastTipSplitUnattributed: "Das Gesamtbudget hat sich ohne erfasste Budgetänderung verschoben – etwa durch geänderte Kapazität, Abwesenheiten oder Feiertage, ein Rückgängigmachen oder eine wiederhergestellte Version. Prüfen Sie das Aktivitätsprotokoll auf Budgetänderungen in diesem Zeitraum.",
  forecastSplitNoHistory: "Die Aufteilung in Leistung und zusätzlichen Umfang beginnt mit der ersten erfassten Budgetänderung.",
  forecastTipSplitNameUnattributed: "Zur nicht zugeordneten Budgetänderung",
  ...
  aiPromptBudCpiLabel: "Im Plan? (Aufwands-CPI)",
  ...
  dashboardHealthHelp: "So funktionieren die Bewertungen. Gesamt = die schlechteste Bewertung über alle aktiven Aufgaben (rot, wenn eine überfällig oder blockiert ist; gelb, wenn eine heute oder innerhalb von 3 Arbeitstagen fällig ist). Zeitplan = Fälligkeitstermine von Aufgaben und Meilensteinen sowie der Zeitplan-Index Aufwands-SPI. Budget = der VAC beim aktuellen Tempo (Gelb unter null, Rot bei −10 % des Budgets), sobald seit der ersten Buchung 20 Arbeitstage vergangen sind und in den letzten 20 Arbeitstagen Stunden gebucht wurden; andernfalls, auch wenn zuletzt nichts gebucht wurde, Ausgaben gegenüber Budget – sowie der Kosten-Index Aufwands-CPI. Bleibt grau, bis ein Budget festgelegt ist. Umfang = offene Änderungsanträge. Die Indizes Aufwands-SPI und Aufwands-CPI fügen nur Gelb (unter 0,9) oder Rot (unter 0,8) hinzu; ein Index von 0,9 oder höher beeinflusst die Farbe nicht. Grün ist also der Normalzustand: Ein Projekt ist grün, solange nichts überfällig, bald fällig, über Budget oder bei Aufwands-SPI oder Aufwands-CPI im Rückstand ist. Jede Bewertung kann unten manuell überschrieben werden.",
  ...
  reportsGroupOutOfScope: "{0} außerhalb des Umfangs",
  tabRaid: "RAID",
  ...
  versionBuild: "Build",
  versionHighlightsHeader: "Was es auszeichnet",
  versionPitch: "Das KI-Projektmanagement-Cockpit, das Ihr Projekt kennt.",
  versionHighlightCopilot: "Ein Claude-Copilot, der Ihre Betriebsleitfäden und die aktuelle Ansicht kennt: Er schlägt die nächste Aktion vor und kann sie ausführen.",
  versionHighlightLimits: "Ehrlich über seine Grenzen: Er nennt beim Namen, was er nicht sehen kann.",
  versionHighlightStack: "Bindet Microsoft 365, Jira und Timelog an, statt ein weiteres Datensilo zu werden.",
  versionHighlightLocalFirst: "Lokal zuerst, mit eigenem API-Schlüssel: kein Backend-Konto, Schlüssel verschlüsselt auf Ihrem Gerät.",
  versionHighlightScales: "Ein Werkzeug vom Solo-Berater bis zum regulierten Programm mit mehreren Arbeitssträngen.",
  versionLicenseLabel: "Lizenz",
  versionLicenseName: "European Union Public Licence v1.2 (EUPL-1.2)",
  versionAuthor: "Erstellt von Sebastian Maute",
  ...
  versionSponsorLink: "Auf GitHub unterstützen",
  ...
  timelogGuardrailCoverageNote: "Dieser Abruf deckt für keine Person den ganzen Tag ab. Deshalb lässt sich für TimeLog-Leitplanken-Hinweise nicht bestätigen, dass sie erledigt sind. Sie bleiben offen, bis Sie sie unter „Erkenntnisse“ verwerfen.",
  ...
  raciSuggestSkippedHandover:
    "{0} vorgeschlagene Zuordnungen wurden abgelehnt, da es sich jeweils um eine Übergabe der Rechenschaftspflicht handelt. Ändern Sie den Rechenschaftspflichtigen manuell.",
  raciSuggestSkippedHandoverOne: "1 vorgeschlagene Zuordnung wurde abgelehnt, da es sich um eine Übergabe der Rechenschaftspflicht handelt. Ändern Sie den Rechenschaftspflichtigen manuell.",
  ...
  dashboardOutOfScopeCount: "Außerhalb des Umfangs",
  dashboardAllCancelled: "Alle außerhalb des Umfangs ({0})",
  ...
  evmSv: "Terminabw. (SV)",
  evmCv: "Kostenabw. (CV)",
  evmSpiHint: "Aufwands-Terminleistungsindex = geschätzter Aufwand erledigter Aufgaben ÷ geschätzter Aufwand der bis heute fälligen Aufgaben. Über 1 heißt: vor dem Zeitplan.",
  evmCpiHint: "Aufwands-Kostenleistungsindex = geschätzter Aufwand erledigter Aufgaben ÷ auf Aufgaben gebuchte Zeit. Über 1 heißt: Aufgaben brauchen weniger Aufwand als geschätzt. Nicht der preisbasierte Index der Prognose.",
  ...
  trendKpiSpi: "Aufwands-SPI",
  trendKpiCpi: "Aufwands-CPI",
  ...
  actionScheduleWhyBehind: "Aufwands-Terminleistungsindex liegt bei {0} (unter 1,0 = hinter Plan)",
  actionScheduleWhySlipping: "Aufwands-SPI {0} — Zeitplan verzögert sich",
  actionScheduleWhyImproving: "Aufwands-SPI {0} — im Rückstand, aber verbessert sich",
  ...
  actionBudgetWhyCpi: "Kostenleistung unter Ziel (Aufwands-CPI {0})",
  actionBudgetWhyWorsening: "Aufwands-CPI {0} — über Budget und verschlechtert sich",
  actionBudgetWhyImproving: "Aufwands-CPI {0} — über Budget, aber verbessert sich",
  ...
  budgetCciBurnHint: "Budgetierte Kosten ÷ bisherige Kosten. Über 100 % bedeutet, dass bisher weniger ausgegeben wurde als budgetiert. Dies ist kein EVM-Index — siehe Interner Kostenindex.",
  ...
  naScheduleSpiWarn: "Termin: Aufwands-SPI — warnen unter",
  naScheduleSpiWarnHint: "Eine Terminaktion auslösen, wenn der Aufwands-Terminleistungsindex unter diesen Wert fällt (1,0 = im Plan).",
  naScheduleSpiCritical: "Termin: Aufwands-SPI — kritisch unter",
  naScheduleSpiCriticalHint: "Die Terminaktion auf kritisch hochstufen, wenn der Aufwands-SPI unter diesen Wert fällt.",
