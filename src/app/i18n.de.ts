...
export const de: Record<TranslationKey, string> = {
  ...
  forecastTileRange: "EAC {0}–{1} · VAC {2} bis {3}",
  forecastTileSingle: "EAC {0} · VAC {1}",
  forecastTileRunsOut: "aufgebraucht am {0}",
  ...
  forecastTileActuals: "Ist {0} von {1}",
  ...
  forecastTipPace: "Nimmt an, dass die Ausgaben im Durchschnitt der letzten {0} Arbeitstage bis zum geplanten Enddatum weitergehen. Berücksichtigt nur den Kalender: Es wird angenommen, dass die Arbeit zum Planende fertig ist, unabhängig vom tatsächlichen Fortschritt. Dies ist die AIPM-Projekt-Burndown-Methode.",
  ...
  dashboardSpentHint: "Bisherige Ausgaben gegenüber dem Gesamtbudget, eingefärbt nach diesem Verhältnis. Nicht die Prognose — die Zeile darüber zeigt, wohin sich das Budget entwickelt.",
