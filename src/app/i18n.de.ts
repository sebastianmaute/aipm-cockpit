...
export const de: Record<TranslationKey, string> = {
  ...
  dashboardChangesEmpty: "Noch keine Aenderungen.",
  ...
  changeFieldResolution: "Loesung / Begruendung",
  changeFieldLinkedTasks: "Verknuepfte Aufgaben",
  changeFieldLinkedRaid: "Verknuepfte RAID-Eintraege",
  changeFilterSearch: "Aenderungen suchen...",
  changeFilterTypeAll: "Alle Typen",
  changeFilterStatusAll: "Alle Status",
  changeEmpty: "Noch keine Aenderungen. Erfassen Sie einen Aenderungsantrag, um das Register zu starten.",
  changeNoMatches: "Keine Aenderungen entsprechen den aktuellen Filtern.",
  ...
  versionHighlightChangeLog: "Aenderungs-Log - ein RAID-Schwesterregister fuer Aenderungsantraege",

  navStakeholders: "Stakeholder",
  stakeholderRaciTitle: "RACI-Matrix",
  stakeholderMapTitle: "Einfluss / Interesse",
  stakeholdersAdd: "Stakeholder hinzufuegen",
  ...
  stakeholderFieldResource: "Verknuepfte Ressource",
  ...
  raciNoMilestones: "Meilensteine hinzufuegen, um die RACI-Matrix aufzubauen.",
  raciNoStakeholders: "Stakeholder hinzufuegen, um die RACI-Matrix aufzubauen.",
