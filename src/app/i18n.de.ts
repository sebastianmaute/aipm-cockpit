...
export const de: Record<TranslationKey, string> = {
  ...
  versionHighlight0221: "Ein Projekt mit mehr Dokumenten, als die App öffnen konnte, verlor sie bisher. Beim Öffnen wurde nur der erste Teil behalten und der Rest stillschweigend verworfen, und das nächste automatische Speichern schrieb diese gekürzte Liste über Ihre Datei - dauerhaft, bei jeder Speicheroption. Das Limit ist jetzt fünfmal so hoch, gewöhnliche Projekte sind also gar nicht betroffen. Überschreitet eine Datei es dennoch, sagt die App das deutlich und pausiert das Speichern, damit Ihr Original alles behält, bis Sie entscheiden: die Datei außerhalb der App reparieren oder den Verlust mit einem Klick akzeptieren.",
