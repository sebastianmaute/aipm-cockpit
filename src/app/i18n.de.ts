...
export const de: Record<TranslationKey, string> = {
  ...
  helpSecProjectsBody: "Hier stehen alle registrierten Projekte, das aktuelle ist markiert. Der Wechsel zu einem anderen Projekt lädt dessen Arbeitsbereich und dessen eigene aktivierte Funktionen ohne Neuladen der Seite. Nur die Zeile des aktuellen Projekts bietet Bearbeiten, Export und Löschen — die übrigen nur den Wechsel, denn ausschließlich der Arbeitsbereich des aktuellen Projekts liegt im Speicher. Löschen entfernt lediglich die Registrierung; die zugrunde liegende Datei oder Datenbank bleibt unangetastet. Beim Hinzufügen führt ein dreistufiger Assistent (Details, Vorlage, Funktionen) durch die Anlage, wahlweise als JSON, CSV oder Markdown.",
  helpSecPortfolioHealthTitle: "Portfolio-Status",
  helpSecPortfolioHealthBody: "Eine projektübergreifende Auswertung, verfügbar mit Turso als Speicher-Backend. Sie lädt den Arbeitsbereich jedes Portfolio-Projekts nur lesend, berechnet ihn mit derselben Engine wie das Dashboard und zeigt Gesamtkennzahlen über einer Tabelle je Projekt; ein Klick auf eine Zeile wechselt dorthin. Da nur gelesen wird, ist die Ansicht auch in einem separaten Fenster unbedenklich. Ohne gültige Turso-Konfiguration erklärt die Ansicht, was ihr fehlt, statt Zahlen zu zeigen.",
  helpAutomatedInsightsTitle: "Erkenntnisse entstehen von selbst",
  helpAutomatedInsightsBody: "Die App achtet auf fünf Muster und hält fest, was sie findet: verrutschte Meilensteine, einen sich verschlechternden Überfälligkeits-Trend, liegengebliebene Arbeit, Budgetabweichungen und alternde RAID-Einträge. Eine Erkenntnis legen Sie nie selbst an. Jede trägt einen Status — aktiv, zur Kenntnis genommen, bearbeitet, verworfen oder erledigt —, damit Erledigtes nicht weiter um Aufmerksamkeit konkurriert. Das Dashboard zeigt die noch offenen — aktive und zur Kenntnis genommene; die Ansicht Erkenntnisse ist das vollständige Protokoll, mit Filtern nach Status und Typ und einem Schalter, der verworfene und erledigte Einträge wieder einblendet.",
  helpSecTimelogTitle: "Zeitbuchungen",
  helpSecTimelogBody: "Holt gebuchte Stunden aus Timelog und stellt sie diesem Projekt gegenüber. Personen und Projekte werden automatisch zugeordnet, wo die Namen übereinstimmen; den Rest bestätigen oder korrigieren Sie von Hand. Kennzahlen-Kacheln fassen den Fund zusammen. Der Übernahmeschritt schreibt die zugeordneten Ist-Werte in Ihre Budget-Positionen und listet vorher genau die Zeilen auf, die sich ändern würden — Sie bestätigen also die Wirkung, nicht die Absicht.",
  helpSecReportsTitle: "Berichte",
  helpSecReportsBody: "Auswertungen zum Lesen und Drucken, ohne Bearbeitungsmöglichkeit. Berichte deckt die Aufgaben ab: Summen für offen, abgeschlossen, abgebrochen und überfällig, pünktlich gegenüber verspätet abgeschlossen, Rückfragen sowie Aufschlüsselungen nach Gruppe, Label, Zuständigkeit und Priorität. Der RAID-Bericht gliedert das Register nach Schweregrad, Status, Verantwortung, Kategorie und Alter. Für Änderungen und Budget gibt es eigene Berichte nach demselben Muster. Jede Tabelle lässt sich sortieren, die Spalten in der Breite ändern und über ein Textfeld filtern.",
  ...
  helpSecUndoBody: "Strg+Z (Cmd+Z auf dem Mac) nimmt die letzte Änderung zurück; Strg+Umschalt+Z oder Strg+Y stellt sie wieder her. In einem Textfeld hat das Rückgängig des Browsers Vorrang, damit sich das Tippen wie gewohnt verhält. Erfasst wird nach Gruppen zusammengehöriger Felder statt nach Tastendruck: Eine Bearbeitung, die Termine und Zuständigkeit zugleich betraf, kommt daher in zwei Schritten zurück. Der Stapel hat eine feste Tiefe und verwirft die ältesten Einträge, sobald er voll ist. Separate Fenster erfassen nichts — nehmen Sie Änderungen im Hauptfenster vor, wenn Sie sie zurücknehmen können wollen.",
  helpSecInlineAiEditTitle: "Claude einen Datensatz bearbeiten lassen",
  helpSecInlineAiEditBody: "Aufgaben, RAID-Einträge, Änderungen, Meilensteine und Stakeholder lassen sich bearbeiten, indem Sie die Änderung in normaler Sprache beschreiben, ohne die Zeile zu verlassen. Das Modell antwortet mit einem Plan statt mit einer Aktion: Sie sehen jedes Feld, das es anfassen will, mit aktuellem und neuem Wert, und nichts wird geschrieben, bevor Sie bestätigen. Statt zu bestätigen können Sie auch nachbessern lassen. Bei Feldern mit formatiertem Text erscheint die Vorschau als reiner Text, während der tatsächlich gespeicherte Wert seine Formatierung behält.",
  helpSecDigestTitle: "Wöchentlicher Statusbericht",
  helpSecDigestBody: "Eine schriftliche Zusammenfassung, die aus den Zahlen des Dashboards selbst entsteht und nicht aus einer zweiten Rechnung — beide können daher nicht auseinanderlaufen. Sie ist ausgeschaltet, bis Sie sie einschalten, und den Rhythmus bestimmen Sie. Sie hält fest, wo das Projekt steht und was sich seit dem vorigen Bericht geändert hat. Bei verbundenem Microsoft 365 lässt sie sich zusätzlich per E-Mail zuschicken — Empfänger ist die Adresse des angemeldeten Kontos, Sie erhalten also selbst eine Kopie und verteilen den Bericht nicht an andere.",
  helpSecTableColumnsTitle: "Spaltenbreiten",
  helpSecTableColumnsBody: "Ziehen Sie die Trennlinie im Tabellenkopf, um eine Spaltenbreite zu setzen; die Zurücksetzen-Schaltfläche in der Werkzeugleiste stellt alle Spalten wieder her. Breiten werden je Tabelle auf diesem Gerät gespeichert, und zwar nur für die Spalten, die Sie tatsächlich gezogen haben — eine später verbesserte Standardbreite kann Sie so noch erreichen, statt auf dem zuerst gesehenen Wert festzustehen.",
