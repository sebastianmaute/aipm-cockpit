...
export const de: Record<TranslationKey, string> = {
  ...
  forecastTipPace: "Nimmt an, dass die Ausgaben im Durchschnitt der letzten {0} Arbeitstage bis zum geplanten Enddatum weitergehen. Berücksichtigt nur den Kalender: Es wird angenommen, dass die Arbeit zum Planende fertig ist, unabhängig vom tatsächlichen Fortschritt. Dies ist die Projekt-Burndown-Methode.",
