...
export const de: Record<TranslationKey, string> = {
  ...
  helpConceptDocumentTitle: "Dokumente",
  helpConceptDocumentBody: "Was: Die Ansicht Dokumente sammelt jede Datei, die irgendwo im Projekt verknüpft ist — mit einer Aufgabe, einem RAID-Eintrag, einer Änderung, einem Meilenstein, einem Stakeholder oder dem Projekt selbst.\n\nWarum wichtig: Verstreute Links sind schwer zu finden; ein Ort zum Ansehen, Filtern und Öffnen hält Nachweise und Referenzen griffbereit.\n\nIn dieser App: Verknüpfen Sie ein Dokument per URL (jede Quelle) oder wählen Sie eines aus SharePoint, filtern Sie das Raster nach Quelle, suchen Sie nach Namen und springen Sie direkt zum zugehörigen Element.",
