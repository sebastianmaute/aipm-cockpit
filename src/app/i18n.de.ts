...
export const de: Record<TranslationKey, string> = {
  ...
  forecastTitle: "Prognosen",
  forecastWhatIs: "Was ist {0}?",
  forecastFactBac: "Budget (BAC)",
  forecastFactAc: "Ist-Kosten (AC)",
  forecastFactRemaining: "Verbleibend",
  ...
  forecastTipEv: "Erarbeiteter Wert: der Budgetwert der tatsächlich fertiggestellten Arbeit, {0} ({1} fertig). Er kann niedriger sein als das Ausgegebene (AC), wenn die Arbeit mehr kostet als geplant.",
  ...
  forecastTipEac: "Schätzung bei Fertigstellung: Ist-Kosten {0} + ETC {1} = {2}. Über dem Budget heißt: Überschreitung.",
  ...
  forecastTipCpi: "Kostenleistungsindex: erarbeiteter Wert {0} ÷ Ist-Kosten {1} = {2}. 1,00 bedeutet: Die Arbeit kostet wie budgetiert; unter 1 bedeutet: Sie kostet mehr als geplant.",
  forecastTipSpi: "Terminleistungsindex: erarbeiteter Wert {0} ÷ Planwert {1} = {2}. Unter 1 heißt: hinter dem Zeitplan.",
  forecastTipBurnRate: "Durchschnittlich gebuchter Wert je Arbeitstag: {0} in den letzten {1} Arbeitstagen = {2} pro Tag.",
  forecastTipRunOut: "Der Arbeitstag, an dem das Restbudget {0} bei {1} pro Tag aufgebraucht ist. Vor dem Planende heißt: Das Budget reicht nicht bis zum Ende.",
