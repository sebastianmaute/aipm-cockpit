...
export const de: Record<TranslationKey, string> = {
  ...
  versionHighlightActorAttribution: "Jeder Eintrag im Aktivitätsverlauf des Projekts hält jetzt fest, wer die Änderung vorgenommen hat — Sie, der Assistent oder eine Integration wie Jira oder der Kalenderabgleich. Der Assistent hat bisher überhaupt nichts protokolliert, seine Änderungen waren also unsichtbar; sie werden jetzt wie jede andere Änderung aufgezeichnet, und die Aktivitätsansicht zeigt den Urheber an und lässt sich danach filtern. Der Assistent erhält außerdem eine kurze Zusammenfassung der Aktivitäten der letzten sieben Tage und weiß so, was zuletzt geschehen ist, bevor Sie fragen. Einträge aus der Zeit vor dieser Version tragen keinen Urheber, weil er sich nachträglich nicht rekonstruieren lässt — sie werden als nicht zugeordnet ausgewiesen und nicht geraten. Sowohl die Verlaufssuche als auch die Aktivitätszusammenfassung lassen sich in den Einstellungen abschalten.",
