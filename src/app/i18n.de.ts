...
export const de: Record<TranslationKey, string> = {
  ...
  diagnosticsUnitError: "Fehler",
  diagnosticsUnitWarnOne: "Warnung",
  diagnosticsUnitWarn: "Warnungen",
  ...
  bulkEditTitle: "Sammelbearbeitung ({0} Aufgaben)",
  bulkApplyOne: "Auf 1 Aufgabe anwenden",
  bulkApply: "Auf {0} Aufgaben anwenden",
  ...
  budgetFxRateUnresolved: "kein Wechselkurs – 1:1 umgerechnet",
  budgetFxRollupUnresolved: "Enthält {0} Budgetposten ohne Wechselkurs, 1:1 gezählt",
  budgetFxRollupUnresolvedOne: "Enthält 1 Budgetposten ohne Wechselkurs, 1:1 gezählt",
  ...
  helpSecResourcesBody:
    "Kapazitäts- und Kontaktverwaltung für die Personen im Projekt, in fünf Unter-Tabs. Verzeichnis ist ein Adressbuch – eine Zeile pro Ressource mit Name, Titel, Kontaktdaten, Firma und Geburtstag; Klick auf einen Namen öffnet die Bearbeitung, oder \"+ Ressource hinzufügen\". Auslastung zeigt Statistiken pro Zugewiesenem (offene / überfällige Aufgaben, kommende Abwesenheiten, hinterlegte Schicht); Zugewiesene ohne Ressource erscheinen unter \"Nicht verknüpft\". Kalender ist ein Tagesraster mit Aufgaben, Abwesenheiten, Feiertagen und Terminen pro Ressource – über einen Monat, eine Woche oder einen von Ihnen gewählten Zeitraum. Planung ist das Auslastungsraster pro Periode (Woche oder Monat) → Kapazität, interne/externe Kosten und Marge, mit schreibgeschützter Rollup-Ansicht und Pop-out-Bericht. Rollen verwalten enthält die Kostensätze – interne und externe Sätze je Rolle, wahlweise pro Tag oder pro Stunde. Schichten und Abwesenheiten hinzufügen, um die Verfügbarkeit zu formen; Geburtstage lösen eine Erinnerung aus. Ressourcendaten liegen im selben Speicher-Backend wie die Aufgaben.",
  ...
  arrangementTileWidth: "Breite",
  arrangementTileHeight: "Höhe",
  arrangementTileFixedAt: "Fest auf {0}",
  arrangementTileMoveEarlier: "Nach vorne verschieben",
  arrangementTileMoveLater: "Nach hinten verschieben",
  arrangementTileMoveFirst: "An den Anfang verschieben",
  arrangementTileHide: "Ausblenden",
  ...
  actionWorkloadWhyOverloadOne: "1 überfällige Aufgabe zugewiesen",
  ...
  documentsTruncatedWarningOne: "1 Dokumenteintrag konnte nicht geöffnet werden - dieses Projekt überschreitet das Limit. Das Speichern ist pausiert, damit nichts überschrieben wird.",
  ...
  documentsUnreadableWarningOne: "1 Art gespeicherter Daten konnte nicht gelesen werden. Das Speichern ist pausiert, damit nichts überschrieben wird.",
  documentsUnreadableCount: "{0} Arten gespeicherter Daten konnten nicht gelesen werden.",
  documentsUnreadableCountOne: "1 Art gespeicherter Daten konnte nicht gelesen werden.",
  ...
  documentsTruncatedBlocksWarningOne: "1 Block in gespeicherten Dokumenten konnte nicht geöffnet werden. Das Speichern ist pausiert, damit nichts überschrieben wird.",
  ...
  documentsTruncatedEntriesCountOne: "1 Dokumenteintrag konnte nicht geöffnet werden.",
  documentsTruncatedBlocksCount: "{0} Blöcke in gespeicherten Dokumenten konnten nicht geöffnet werden.",
  documentsTruncatedBlocksCountOne: "1 Block in gespeicherten Dokumenten konnte nicht geöffnet werden.",
  ...
  actionMoreReasonsOne: "+1 weiterer Grund",
  ...
  actionRaidWhyReviewStaleOne: "Seit 1 Tag nicht überprüft",
  actionChangeAggTitle: "{0} Änderungen warten auf Entscheidung",
  actionChangeAggTitleOne: "1 Änderung wartet auf Entscheidung",
  ...
  actionCommitteeInfoWhyOne: "Fällig {0} — {1} (1 Tag)",
  ...
  budgetCciRecoveryHint: "Erarbeiteter Wert ÷ tatsächliche Kosten. 100 % oder mehr bedeutet, dass die bisher gelieferte Arbeit mindestens so viel wert ist wie die dafür ausgegebenen Kosten. Benötigt verknüpfte Aufgaben oder einen manuellen Fertigstellungsgrad am Budgetposten zur Berechnung.",
  ...
  budgetWinLossHint: "Festpreis: Erlös minus Kosten. Time-and-Material: Budget minus Verbrauch, also das verbleibende Budget. In der Währung des Budgetpostens; negativ bedeutet, dass der Bucket mit Verlust läuft.",
  budgetSpilloverInHint: "Aus einem anderen Bereich übertragene Stunden und deren Wert in der Währung des Budgetpostens.",
  ...
  helpAutomatedHealthBody: "Die App leitet die Ampeln für Gesamt, Termin, Budget und Umfang — rot, gelb oder grün — direkt aus Aufgaben, Meilensteinen, Budget und Änderungen ab, ganz ohne manuelle Statuspflege. Earned-Value-Kennzahlen wie der Terminleistungsindex (SPI) und der Kostenleistungsindex (CPI) aktualisieren sich automatisch, und das Burn-down-Diagramm stellt das geplante Restbudget dem bisherigen tatsächlichen Restbudget gegenüber. Auf einem Turso-Backend erstellt die App zudem regelmäßige Fortschritts-Momentaufnahmen für die Trends-Ansicht.",
  ...
  helpSecMeetingSeriesTitle: "Terminserien",
  helpSecMeetingSeriesBody: "Ressourcen → Kalender enthält neben Aufgaben, Abwesenheiten und Feiertagen auch Termine. Ein Termin hat einen Titel, ein erstes Vorkommen, eine Startzeit, eine Dauer und einen Ort und kann sich täglich, wöchentlich oder monatlich wiederholen — monatlich entweder nach Tag des Monats oder nach Wochentag, etwa am zweiten Dienstag. Eine Wiederholung endet nie, an einem Datum oder nach einer Anzahl von Vorkommen; nur eine dieser Angaben bleibt erhalten, ein Enddatum löscht also eine zuvor eingegebene Anzahl. Ziehen Sie ein einzelnes Vorkommen auf einen anderen Tag, verschiebt sich nur dieses, während die übrige Serie unverändert bleibt; per Tastatur startet Alt+Links oder Alt+Rechts die Verschiebung, Enter übernimmt sie und Escape bricht ab. Wird \"Wiederholung\" zurück auf \"Nie\" gesetzt, gehen diese einzelnen Anpassungen verloren — der Dialog weist vor dem Speichern darauf hin, und Rückgängig stellt sie in einem Schritt wieder her. Serien, deren Termine außerhalb des angezeigten Zeitraums liegen, bleiben über die Liste unter dem Raster erreichbar, und in Pop-out-Fenstern ist der Kalender schreibgeschützt.",
  helpSecDocumentAssetsTitle: "Bilder in Dokumenten",
  helpSecDocumentAssetsBody: "Dokumente können Bilder enthalten, wenn das Projekt Turso als Speicher-Backend nutzt; die Dokumente selbst funktionieren mit jedem Backend, die Bildbibliothek nicht. Fügen Sie ein Bild über die Auswahl, aus der Zwischenablage oder per Ablegen auf dem Dokument hinzu — PNG, JPEG und WebP werden akzeptiert. Alles über 1920 mal 1080 wird vor dem Speichern verkleinert, wobei das Original erhalten bleibt, wenn das Verkleinern nichts einspart. Wird dasselbe Bild ein zweites Mal hochgeladen, verwendet die App die bereits gespeicherte Kopie weiter. Ein eingefügtes Bild entsteht als neuer Block am Ende des Dokuments; ein Block mit Bild ist schreibgeschützt, tauschen Sie also das Bild aus, statt darum herum zu schreiben. Ein Dokument fasst bis zu 20 verschiedene Bilder. Word- und PowerPoint-Exporte übernehmen die Bilder in voller Größe; HTML und PDF betten sie ein, bis ein Größenbudget aufgebraucht ist, und hinterlassen danach einen Platzhalter mit dem Bildnamen, sodass nichts unbemerkt verschwindet. Das Löschen eines noch verwendeten Bildes wird vorher bestätigt.",
  helpSecTaskEffortTitle: "Schätzungen und Zeiterfassung",
  helpSecTaskEffortBody: "Der Abschnitt Aufwand einer Aufgabe enthält die ursprüngliche Schätzung; die Schaltfläche \"Zeiterfassung\" daneben öffnet einen Dialog für erfasste und verbleibende Zeit. Dauern werden wie in Jira eingegeben — \"2w 3d 4h 30m\" —, wobei ein Tag 8 Stunden und eine Woche 5 Tage sind. Bleibt die verbleibende Zeit leer, folgt sie der Schätzung: sie zählt mit der erfassten Zeit herunter und bleibt bei null stehen. Eine eingetragene 0 ist die andere, bewusste Aussage, dass keine Arbeit mehr offen ist. Der Dialog schreibt in das geöffnete Aufgabenformular, nicht in den Speicher — gespeichert werden die Werte erst mit der Aufgabe, und Speichern ist deaktiviert, solange ein Feld etwas enthält, das sich nicht als Dauer lesen lässt. Diese Werte gehören zur Aufgabe selbst: sie sind nicht die Integration Zeitbuchungen und werden nirgendwohin synchronisiert. Eine Aufgabe mit einer Schätzung über null fließt außerdem in die Earned-Value-Kennzahlen im Budgetbericht und im Dashboard ein; eine Aufgabe ohne Schätzung bleibt darin unberücksichtigt.",
  ...
  insightOverdueTrendDetailOne: "1 Aufgabe überfällig — {1} mehr seit Ihrem letzten Besuch ({2} zuvor).",
  ...
  insightStalledWorkDetailOne: "1 aktive Aufgabe ist veraltet, blockiert oder wartet auf eine Abhängigkeit.",
