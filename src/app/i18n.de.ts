...
export const de: Record<TranslationKey, string> = {
  ...
  helpSecDigestBody: "Eine schriftliche Zusammenfassung, die aus den Zahlen des Dashboards selbst entsteht und nicht aus einer zweiten Rechnung — beide können daher nicht auseinanderlaufen. Sie ist ausgeschaltet, bis Sie sie einschalten, und den Rhythmus bestimmen Sie. Sie hält fest, wo das Projekt steht und was sich seit dem vorigen Bericht geändert hat, und lässt sich per E-Mail versenden.",
