...
export const de: Record<TranslationKey, string> = {
  ...
  helpSecTimelogBody: "Holt gebuchte Stunden aus Timelog und stellt sie diesem Projekt gegenüber. Personen werden automatisch über E-Mail, dann Initialen, dann Namen zugeordnet; Projekte über den Positionsnamen, dann die Bestellnummer. Den Rest bestätigen oder korrigieren Sie von Hand, wobei eine manuelle Zuordnung immer Vorrang hat. Kennzahlen-Kacheln fassen zusammen, was gefunden wurde. Der Übernahmeschritt schreibt die zugeordneten Ist-Werte in Ihre Budget-Positionen und listet vorher genau die Zeilen auf, die sich ändern würden — Sie bestätigen also die Wirkung, nicht die Absicht.",
