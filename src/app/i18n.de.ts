...
export const de: Record<TranslationKey, string> = {
  ...
  helpSecSetupWizardBody:
    "Eine geführte, schrittweise Alternative zum flachen Bereich Einstellungen → Integrationen. Starten Sie ihn über die Schaltfläche zum Starten des Einrichtungsassistenten unter Einstellungen → Integrationen oder im Fenster für neue Projekte. Er führt Sie durch Speicher und Verbindungen (Browser-IndexedDB, eine lokale JSON-, CSV- oder Markdown-Datei, eine einzelne Turso-Datenbank oder Multi-Tenant-Turso sowie die Microsoft-365-Anmeldung), dann den KI-Schlüssel, Jira und Timelog – jeder Integrationsschritt ist optional und kann übersprungen werden – und endet mit einer Zusammenfassung des konfigurierten Status. Alle Änderungen entsprechen dem Bearbeiten des flachen Integrationen-Bereichs; der Bereich bleibt für spätere Änderungen verfügbar. Der Assistent wird in Pop-out-Fenstern nicht angezeigt.",
