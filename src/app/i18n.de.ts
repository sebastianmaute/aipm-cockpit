...
export const de: Record<TranslationKey, string> = {
  ...
  schemeTokenShadowCard: "Kartenschatten",
  schemeTokenShadowControl: "Steuerelement-Schatten",
  schemeTokenShadowCardHover: "Karten-Hover-Schatten",
  schemeTokenGradientKpi: "KPI-Verlauf",
  schemeTokenDeltaChipPad: "Delta-Chip-Abstand",
  schemeTokenRagGreenChip: "Grüne Chip-Füllung",
  schemeTokenRagRedChip: "Rote Chip-Füllung",
  ...
  rolesRateBasisHint: "Geben Sie entweder den Tagessatz oder den Stundensatz ein — der jeweils andere wird aus Ihren Arbeitsstunden pro Tag berechnet und gesperrt. Leeren Sie das ausgefüllte Feld, um zu wechseln, welchen Sie eingeben.",
