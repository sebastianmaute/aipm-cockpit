...
export const de: Record<TranslationKey, string> = {
  ...
  versionHighlight0236: "Wenn Sie bereits ein Projekt in einer Turso-Datenbank gespeichert haben, können Sie es jetzt vom Einrichtungsbildschirm aus laden, statt nur ein neues, leeres Projekt erstellen zu können. Achten Sie nach der Eingabe Ihrer Datenbankdaten auf den Speichermodus-Schalter.",
