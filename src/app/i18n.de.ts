...
export const de: Record<TranslationKey, string> = {
  ...
  versionHighlight0210: "Exporte behalten Absätze bei, und Aufgabenbeschreibungen werden als Text statt als rohes HTML exportiert. Inline-KI-Bearbeitungen erhalten jetzt die Formatierung einer Beschreibung, statt sie zu einfachem Text zu glätten.",
