...
export const de: Record<TranslationKey, string> = {
  ...
  versionHighlight0212: "Offene Punkte verschwendet keinen Platz mehr an den Rändern der Tabelle: die Spalten für Auswahl, Ampel, Beziehungen und Aktionen sind auf ihren tatsächlichen Inhalt bemessen, und die Aufgaben-Spalte nimmt die übrige Breite auf, statt sie gleichmäßig auf alle Spalten zu verteilen. Ein Ziehen der Aufgaben-Spalte legt sie weiterhin auf eine feste Breite fest, und Spalten zurücksetzen stellt das flexible Layout wieder her. In der Planung steht Externe ausblenden jetzt neben den Outlook-Kalender-Bedienelementen, und die RACI-Matrix beginnt ihre Symbolleiste mit RACI vorschlagen.",
