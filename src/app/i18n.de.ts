...
export const de: Record<TranslationKey, string> = {
  ...
  helpSecTimelogBody: "Holt gebuchte Stunden aus Timelog und stellt sie diesem Projekt gegenüber. Zeitbuchungen ist ein Modul je Projekt — die Ansicht gibt es also nur, wenn sie für das Projekt, in dem Sie gerade sind, eingeschaltet ist. Personen werden automatisch über E-Mail, dann Initialen, dann Namen zugeordnet; Projekte über den Positionsnamen, dann die Bestellnummer. Den Rest bestätigen oder korrigieren Sie von Hand, wobei eine manuelle Zuordnung immer Vorrang hat. Kennzahlen-Kacheln fassen zusammen, was gefunden wurde. Der Übernahmeschritt schreibt die zugeordneten Ist-Werte in Ihre Budget-Positionen und listet vorher genau die Zeilen auf, die sich ändern würden — Sie bestätigen also die Wirkung, nicht die Absicht.",
  helpSecReportsTitle: "Berichte",
  helpSecReportsBody: "Auswertungen zum Lesen und Drucken, ohne Bearbeitungsmöglichkeit. Berichte deckt die Aufgaben ab: Summen für offen, abgeschlossen, abgebrochen und überfällig, pünktlich gegenüber verspätet abgeschlossen, Rückfragen sowie Aufschlüsselungen nach Gruppe, Label, Zuständigkeit und Priorität. Der RAID-Bericht gliedert das Register nach Schweregrad, Status, Verantwortung, Kategorie und Alter. Für Änderungen und Budget gibt es eigene Berichte nach demselben Muster. Die Spaltenbreiten lassen sich in jeder Tabelle ändern; die meisten lassen sich zusätzlich sortieren, manche über ein Textfeld filtern.",
