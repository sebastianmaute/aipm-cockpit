...
export const de: Record<TranslationKey, string> = {
  ...
  activityRedo: "Wiederherstellen: {0} Element(e) erneut angewendet",
  redo: "Wiederherstellen",
  redoTooltip: "Letzte Änderung wiederherstellen",
  redoRestored: "{0} Änderung(en) wiederhergestellt",
  ...
  versionHighlightRedo: "Wiederherstellen: Ein Rückgängig mit Strg/Cmd+Umschalt+Z oder der Wiederherstellen-Schaltfläche in der Kopfleiste zurücknehmen — für Löschungen, Sammelbearbeitungen und Alles-löschen auf jedem Speicher-Backend.",
};
