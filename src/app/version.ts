...
// The release also adds a complete generated sample workspace —
// sample-workspace.json plus sample-workspace.sqlite3 (schema v9, for direct
// Turso import via `turso db create ... --from-file`) — derived from the
// curated sample-workspace.md by scripts/generate-sample-workspace.ts.
