...
export const APP_VERSION = "0.263.3";
export const APP_BUILD_DATE = "2026-08-29"; // 0.263.3: destructive-save-arming coverage for AI clear-all and bulk resource delete (Okorafor)
