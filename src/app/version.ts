...
export const APP_BUILD_DATE = "2026-09-22"; // 1.13.1: a brand-rename patch — Outlook sync tags events AIPM:<project> and its body reads "Managed by AI PM Cockpit.", the importable theme file is petrol.json, the dead legacy style value is gone (a stored one still loads as custom), and brand mentions in code, comments and help text are reworded (Connelly)
