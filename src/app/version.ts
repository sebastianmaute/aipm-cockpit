 ...
 *  0.294.x line is "Borges" (Jorge Luis Borges, Argentine author of "Ficciones"
 ...
 *  ★★★ 0.294.0 SHIPPED ONCE ALREADY AS "Chiang" AND WAS RENAMED WITHIN THE
 ...
 *  0.294.x sweep for "Borges", checked BEFORE the (re-)bump, by BOTH commands
 ...
 *  renamed 0.294.0 header — and `"Moorcock"` 1) and the negative control
...
// Bump BOTH together.
export const APP_MILESTONE = "Borges";
