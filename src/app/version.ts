...
export const APP_BUILD_DATE = "2026-06-13"; // 0.77.0 Action Center — ranked Now/Soon/Monitor suggested-actions queue + dashboard widget + nav badge
/** Minor-series milestone codename (sci-fi/fantasy author names). The whole
 *  0.77.x line is "Russ" (Joanna Russ); patch releases inherit
