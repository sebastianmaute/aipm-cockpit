...
export const APP_BUILD_DATE = "2026-06-13"; // 0.78.0 reminders folded into the Action Center + per-action snooze
/** Minor-series milestone codename (sci-fi/fantasy author names). The whole
 *  0.78.x line is "Hopkinson" (Nalo Hopkinson); patch releases inherit
