...
export const APP_BUILD_DATE = "2026-06-16"; // 0.97.0 context-aware Claude core
/** Minor-series milestone codename (sci-fi/fantasy author names). The whole
 *  0.97.x line is "Gaiman" (Neil Gaiman); patch releases inherit
 *  their minor version's codename rather than getting their own. */
export const APP_MILESTONE = "Gaiman";
