        ...
        {method === "describe" && (
          <label className="flex flex-col gap-1 text-sm">
            ...
            <textarea
              ...
              className="rounded-md border border-line bg-surface px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ui-green"
            />
          </label>
        )}
          ...
          <div className="flex flex-col gap-2 text-sm">
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                className="rounded-md border border-line bg-surface px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ui-green"
              />
            </label>
            <div>
              <Button
