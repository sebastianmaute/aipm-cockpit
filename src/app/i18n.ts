...
const enUS = {
  ...
  versionHighlight0210: "Exports keep paragraph breaks, and task descriptions export as text instead of raw HTML. Inline AI edits now keep a description's formatting instead of flattening it to plain text.",
