...
const enUS = {
  ...
  versionHighlight0221: "A project with more documents than the app could open used to lose them. Opening such a file kept the first batch and quietly discarded the rest, and the next automatic save wrote that shortened list back over your file - permanently, on every storage option. The limit is now five times higher, so ordinary projects are simply unaffected. If a file still goes over it, the app says so plainly and pauses saving, so your original keeps everything until you decide: repair the file outside the app, or accept the loss with one click.",
