...
const enUS = {
  ...
  helpAutomatedInsightsBody: "The app watches for five patterns and records what it finds: milestone slippage, a worsening overdue trend, stalled work, budget variance, and ageing RAID items. You never create an insight by hand. Each one carries a status — active, acknowledged, acted, dismissed or resolved — so a finding you have already dealt with stops competing for your attention. The dashboard surfaces the ones still in play — active and acknowledged; the Insights view is the full log, with filters by status and by type and a toggle that brings resolved and dismissed history back into sight.",
