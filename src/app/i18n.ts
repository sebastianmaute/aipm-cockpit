...
const enUS = {
  ...
  versionHighlight0221: "A project with more documents than the app could open used to lose them. Opening one kept the first batch and quietly discarded the rest, and the next automatic save wrote that shortened list back over your saved project - permanently, on every storage option. The limit is now five times higher, so ordinary projects are simply unaffected. If a project still goes over it, the app says so plainly and pauses saving, so your saved project keeps everything until you accept the loss with one click - and it tells you how much it could not open before you do.",
