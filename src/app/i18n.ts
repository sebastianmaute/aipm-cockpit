...
const enUS = {
  ...
  reportsGroupOutOfScope: "{0} out of scope",
  tabRaid: "RAID",
  ...
  timelogGuardrailCoverageNote: "No person's whole day was covered by this fetch, so TimeLog guardrail findings can't be confirmed resolved from it. They stay open until you dismiss them in Insights.",
  ...
  dashboardOutOfScopeCount: "Out of scope",
  dashboardAllCancelled: "All out of scope ({0})",
  ...
  helpConceptRaidPrimer:
    "A RAID log is one list of everything that could go wrong, alongside the things you are quietly assuming will go right. Writing a worry down is what turns it from a private doubt into something the team can act on.",
  helpConceptChangePrimer:
    "Projects rarely fail in a single dramatic moment; they drift, one small extra at a time. Change control means every extra gets written down and agreed before it quietly becomes work.",
  ...
  helpConceptResourcePrimer:
    "People are not interchangeable hours — each has a limited amount of time, and some of it is already promised elsewhere. Capacity planning is checking that what you assign fits in the time that is free.",
  ...
  helpConceptDependencyPrimer:
    "Some work cannot start until other work has finished. Recording that is how a delay early on shows up as a later finish, instead of surprising everyone in the final week.",
