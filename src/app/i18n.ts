...
const enUS = {
  ...
  versionHighlight0236: "If you already have a project stored in a Turso database, you can now load it from the pre-project setup screen instead of only being able to create a new empty one. Look for the storage-mode switch after entering your database details.",
