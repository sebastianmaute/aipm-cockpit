...
const enUS = {
  ...
  dashboardSpentHint: "Spent so far against the total budget, coloured by that ratio. Not the forecast — the line above shows where the budget is heading.",
