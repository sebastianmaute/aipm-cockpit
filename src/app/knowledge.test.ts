...
describe("collectDocuments", () => {
  it("aggregates links across entities + project with source + index", () => {
    const refs = collectDocuments({
      tasks: [{ id: 1, taskName: "Ship", knowledgeLinks: [doc("a"), doc("b")] }] as never,
      raid: [{ id: 7, title: "Risk", knowledgeLinks: [doc("c")] }] as never,
      changes: [], milestones: [], stakeholders: [],
      project: { id: 0, name: "Demo", knowledgeLinks: [doc("p")] } as never,
    });
