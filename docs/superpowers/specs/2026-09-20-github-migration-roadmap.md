...
**Status 2026-09-23:** design approved, `2026-09-23-issues-migration-design.md`. The import runs at
the flip, not before — it is step 6 of `2026-09-23-flip-checklist.md`, ahead of any PR being opened
in the fresh repository — and issue numbers are preserved across the move.
...
★ **The ordered flip checklist** lives in `2026-09-23-flip-checklist.md` — it carries the issue
import (step 6) and §200's close condition (step 4) in their place among the rest of the flip.
