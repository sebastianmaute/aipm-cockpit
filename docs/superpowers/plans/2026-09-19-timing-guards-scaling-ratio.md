...
- N1 — applied: the raid mutant is the exact pre-fix hunk from `fe253f4fa`, `stripBreakTags(raw).slice(0, max)`; it passes `check`, and the expected red ratio is about 16.
