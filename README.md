...
[![version](https://img.shields.io/badge/version-v0.194.0_%22Stapledon%22-2e7d32)](./CHANGELOG.md)
...
| File | Description |
|------|-------------|
| `sample-workspace-small.json` | Hand-curated demo workspace (master; tasks, RAID, milestones, stakeholders + RACI, budgets, resources, and a few demo document links). The source of truth. |
