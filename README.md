...
| File | Description |
|------|-------------|
| `sample-workspace.md` / `.csv` | Hand-curated demo workspace (tasks, RAID, milestones, stakeholders + RACI, budgets, resources, and a few demo document links). The `.md` is the source of truth. |
